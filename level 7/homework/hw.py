...
user_age = int(input("how old are you?: "))         # აქ ცვლად user_age- მიეცემა საფასური input ფუნქციის გამოყენებით. input არის ფუნქცია რომელიც მომხმარებელს აძლევს უფლებას შემოიტანოს რაიმე ინფორმაცია პროგრამაში
print(user_age)
